<template>
	<view class="customHead" :style="{height:totalHeight+'px'}">
		<view class="bg">
			<image class="bgimg" src="/static/asset/电脑.png" mode="aspectFill"></image>
		</view>		
		<view class="container">
			...
			<view class="body" :class="foldState?'fold':''" :style="{height:bodyBarHeight+'px'}">
				<view class="brand">
					<view class="pic">
						<image class="img" src="/static/asset/电脑.png" mode="aspectFill"></image>
					</view>
					<view class="text">
						<view class="title">
							<text class="font">千鸟网咖点餐品台</text>
							<u-icon class="icon" name="more-circle" size="22" color="#fff"></u-icon>
						</view>
						<view class="des">这里是专属于千鸟网咖的内部点餐品台，</view>
					</view>
				</view>
				<view class="code">
					<view class="pic">
						<image class="img" src="/static/qrcode.png" mode="aspectFill"></image>
					</view>
